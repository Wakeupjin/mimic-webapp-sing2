...
- public/prototype-art/pinocchio-v2/session-01.png
- public/prototype-audio/pinocchio-v2/session-01/lily-british/
...
<!-- HANDOFF:RISKS:START -->
The Session 1 Core master still needs a human listen-through for pronunciation, emotion, and awkward breaths, and the sixty-minute interaction contract needs a learner/classroom pacing pilot. Lily expires on 2026-12-31, so a durable replacement or voice migration plan remains necessary before long-term production. Confirm Korean-market public-domain status before commercial distribution. Remaining sessions and Foundation/Studio media are not generated. This R&D thread must not deploy production.
<!-- HANDOFF:RISKS:END -->
