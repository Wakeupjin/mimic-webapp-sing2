...
export default function PlaybackControls({ onPrev, onNext, onPlay, activeIndex }: PlaybackControlsProps) {
  return (
    <div className="rounded-lg flex items-center justify-center w-fit mx-auto" style={{ backgroundColor: '#201E1E', gap: '10px', paddingTop: '6px', paddingBottom: '6px', paddingLeft: '4px', paddingRight: '4px' }}>
      {/* 이전 버튼 - 동그라미 */}
      <div 
        className="flex items-center justify-center cursor-pointer rounded-lg transition-colors duration-200"
        onClick={onPrev} 
        style={{
          width: '50px',
          height: '50px',
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.backgroundColor = '#201E1E';
        }}
        aria-label="이전 문장"
      >
        <div 
          style={{
            width: '0',
            height: '0',
            borderRight: '30px solid #666666',
            borderTop: '22.5px solid transparent',
            borderBottom: '22.5px solid transparent'
          }}
        />
      </div>
      ...
      {/* 재생 버튼 1 */}
      <div 
        className={`rectangle-1 flex items-center justify-center text-black font-bold text-lg cursor-pointer transition-colors duration-200 ${
          activeIndex === 0 
